...
(* OASIS_START *)
(* DO NOT EDIT (digest: efd893a1d0b6f298638e87745c310322) *)
(*
...
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISContext.ml"
...
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISBuildSection.ml"
  
end

module OASISExecutable = struct
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISExecutable.ml"
  open OASISTypes
...
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISLibrary.ml"
  open OASISTypes
  open OASISUtils
  open OASISGettext
...
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISFlag.ml"
  
end

module OASISPackage = struct
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISPackage.ml"
  
end

module OASISSourceRepository = struct
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISSourceRepository.ml"
  
end

module OASISTest = struct
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISTest.ml"
  
end

module OASISDocument = struct
# 1 "/home/gildor/programmation/oasis/src/oasis/OASISDocument.ml"
...
# 1 "/home/gildor/programmation/oasis/src/base/BaseContext.ml"
...
# 1 "/home/gildor/programmation/oasis/src/base/BaseMessage.ml"
     ...
     package =
       {
          ...
          license =
            OASISLicense.LicenseWithException
              (OASISLicense.LicenseWithVersion (OASISLicense.LGPL, "2"),
          ...
          sections =
            [
               Library
                 ({cs_name = "cryptokit"; cs_data = PropList.Data.create (); 
                  },
                   {
               ...
               Executable
                 ({cs_name = "speedtest"; cs_data = PropList.Data.create (); 
                  },
                   {
                      bs_build =
                        [
               ...
               SrcRepo
                 ({cs_name = "head"; cs_data = PropList.Data.create (); },
                   {
                      src_repo_type = Svn;
                      src_repo_location =
                        "http://scm.ocamlcore.org/svnroot/cryptokit";
               ...
               Test
                 ({cs_name = "bench"; cs_data = PropList.Data.create (); },
                   {
                      test_type = ("custom", Some "0.2.0~alpha1");
                      test_command =
                        [(OASISExpr.EBool true, ("$speedtest", []))];
                      test_custom =
                        {
               ...
               Flag
                 ({cs_name = "zlib"; cs_data = PropList.Data.create (); },
                   {
               ...
               Doc
                 ({
                   ...
                   {
                      doc_type = ("ocamlbuild", Some "0.2.0~alpha1");
                      doc_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)];
          ...
          plugins =
            [
               ("META", Some "0.2.0~alpha1");
               ("DevFiles", Some "0.2.0~alpha1");
               ("StdFiles", Some "0.2.0~alpha1")
            ];
