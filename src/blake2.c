                             ...
                             unsigned int numbytes, int is_last_block)
{
  ...
  for (i = 0; i < 12; i++) {
    ...
    MIX(v0, v4, v8,  v12, m[sigma[0]], m[sigma[1]]);
    MIX(v1, v5, v9,  v13, m[sigma[2]], m[sigma[3]]);
    MIX(v2, v6, v10, v14, m[sigma[4]], m[sigma[5]]);
    MIX(v3, v7, v11, v15, m[sigma[6]], m[sigma[7]]);
    MIX(v0, v5, v10, v15, m[sigma[8]],  m[sigma[9]]);
    MIX(v1, v6, v11, v12, m[sigma[10]], m[sigma[11]]);
    MIX(v2, v7, v8,  v13, m[sigma[12]], m[sigma[13]]);
    MIX(v3, v4, v9,  v14, m[sigma[14]], m[sigma[15]]);
  }
  /* Update state  */
...
void blake2b_final(struct blake2b * s, int hashlen, unsigned char * hash)
{
  ...
  /* The final block is composed of the remaining data padded with zeros.
     If no data remains, it is 128 zeros. */
