...
(* OASIS_START *)
(* DO NOT EDIT (digest: 17c722b09e00ac262ef4cbcf603aafe7) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Enable hardware support for e.g. AES (needs GCC or Clang)";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.ENot
               ...
               Library
                 ({
                      ...
                      bs_ccopt =
                        [
                           ...
                           (OASISExpr.EFlag "hardwaresupport",
                             ["-march=native"]);
                           (OASISExpr.EFlag "zlib", ["-DHAVE_ZLIB"]);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "zlib",
                                OASISExpr.EFlag "hardwaresupport"),
                             ["-DHAVE_ZLIB"; "-march=native"])
                        ];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true, []);
                   ...
                   {
                      lib_modules = ["CryptokitBignum"; "Cryptokit"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "|~\015e|\028\198\002\127\234\245s\029\252\203\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
