...
(* OASIS_START *)
(* DO NOT EDIT (digest: 657b483e8f2e2ae26191f0e278a6cc1e) *)
(*
...
let setup_t =
  {
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim " in ECB, CBC, CFB and OFB modes.";
                 OASISText.Para
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\249\213\148VA\181\014\020k\235\234d\154\225\171\238";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
